        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-background/80 mb-6 max-w-md">
              Professional freelance services for students and small businesses across India. 
              Quality work, affordable prices, fast delivery.
            </p>
            
            <div className="space-y-2">
              <div className="flex items-center space-x-3">
                <Mail className="w-4 h-4 text-primary" />
                <span className="text-background/80">hello@servicehub.in</span>
              </div>
              <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <ul className="space-y-2 text-background/80">
              ...
              <li><a href="#" className="hover:text-primary transition-colors">Content Writing</a></li>
              ...
              <li><a href="#" className="hover:text-primary transition-colors">Academic Services</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-background/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-sm text-background/60">
              <span>© 2024 ServiceHub. All rights reserved.</span>
