      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="fade-in">
            <div className="inline-flex items-center bg-background border border-border rounded-full px-4 py-2 mb-6 shadow-card">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              ...
              <span className="text-primary"> Students & Small Businesses</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Button className="btn-hero px-8 py-4 text-lg rounded-xl">
                Get Started Today
